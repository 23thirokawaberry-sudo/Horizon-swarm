...
var weapon_upgrade = [[[192, 0], "Shotgun unlock", 4], [[224, 32], "Pistol unlock", 5], [[224, 0], "Sword unlock", 6]] #Weapon upgrades - each weapon has a certain max level, after which they no longer can be upgraded.
...
var available_limit = [2, 2] #each position in this list relates to the highest possible value in their indivisual lists.
