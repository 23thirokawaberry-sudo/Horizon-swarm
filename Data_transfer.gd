...
var stage_data = [
	[preload("res://Stages/stage_wave/scenes/tutorial_stage.tscn"), "Tutorial", false],
	[preload("res://Stages/stage_wave/scenes/enemy_spawn_handler.tscn"), "Stage 1", false],
	[preload("res://Stages/stage_wave/scenes/handler_2.tscn"), "Stage 2", false],
	[preload("res://Stages/stage_wave/scenes/handler_3.tscn"), "Stage 3", false],
	[preload("res://Stages/stage_wave/scenes/handler_4.tscn"), "Stage 4", false]]
